    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
               ...
               String sharebody = "Hey, I have used this ResumeBuilder App! It has 50+ resume templates, divided sections to fill in your details.. You can build your resume in just 5 minutes!!";
